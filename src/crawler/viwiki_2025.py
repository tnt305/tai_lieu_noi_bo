...
if os.path.exists("viwiki_2025.jsonl"):
    os.remove("viwiki_2025.jsonl")
...
for item in external_references:
    try:
        ...
        with open("viwiki_2025.jsonl", "a", encoding="utf-8") as f:
...
if content_div:
    ...
    for item in internal_references:
        try:
            ...
            if content is None or content=="None" or url.endswith("svg"):
                continue
