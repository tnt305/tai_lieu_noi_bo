...
if os.path.exists("src/crawler/history.jsonl"):
    os.remove("src/crawler/history.jsonl")
...
for item in external_references:
    try:
        ...
        with open("src/crawler/history.jsonl", "a", encoding="utf-8") as f:
