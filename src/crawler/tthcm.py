...
if os.path.exists("src/crawler/tthcm.jsonl"):
    os.remove("src/crawler/tthcm.jsonl")
...
for item in external_references:
    try:
        ...
        with open("src/crawler/tthcm.jsonl", "a", encoding="utf-8") as f:
